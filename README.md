...
```bash
sudo apt install -y git && git clone git@github.com:apoloravi/Luzap-Install-Auto.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
